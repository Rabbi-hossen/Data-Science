...
table(mydata$Age, useNA = "ifany")
table(mydata$Gender, useNA = "ifany")
table(mydata$Family.History, useNA = "ifany")
table(mydata$Personal.History, useNA = "ifany")
table(mydata$Current.Stressors, useNA = "ifany")
table(mydata$Symptoms, useNA = "ifany")
table(mydata$Severity, useNA = "ifany")
table(mydata$Impact.on.Life, useNA = "ifany")
table(mydata$Demographics, useNA = "ifany")
table(mydata$Medical.History, useNA = "ifany")
table(mydata$Psychiatric.History, useNA = "ifany")
table(mydata$Substance.Use, useNA = "ifany")
table(mydata$Coping.Mechanisms, useNA = "ifany")
table(mydata$Social.Support, useNA = "ifany")
table(mydata$Lifestyle.Factors, useNA = "ifany")
table(mydata$Panic.Disorder.Diagnosis, useNA = "ifany")
...
your_data <-mydata
set.seed(123)
sample_index <- sample(1:nrow(your_data), nrow(your_data) * 0.8)
